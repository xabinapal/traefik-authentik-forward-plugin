...
- `cookiePolicy`: `string`, optional, default `lax` \
  Value of the SameSite attribute of Authentik session cookies sent to the client. It's recommended to set it to `strict`.
